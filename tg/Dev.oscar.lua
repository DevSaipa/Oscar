...
cat << EOF
 ...
 $f1  @Hlusat     (قناة المطورين)     $f2 @Hlusat     (قناة المطورين)     $f3  @Hlusat     (قناة المطورين)   $f4  @Hlusat     (قناة المطورين)    $f5 @Hlusat    (قناة المطورين)    $f6 @Hlusat     (قناة المطورين)  $rst

EOF
echo -e "                \e[100m                Oscar         \e[00;37;40m"
echo -e "               \e[01;34m                 By Memo(@G0vip)                \e[00;37;40m"
echo ""
cat << EOF
 $bld$f1  @Hlusat    (قناة المطورين)     $f2 @Hlusat     (قناة المطورين)     $f3  @Hlusat     (قناة المطورين)   $f4  @Hlusat     (قناة المطورين)    $f5 @Hlusat     (قناة المطورين)    $f6 @Hlusat     (قناة المطورين)  $rst
...
echo ""
echo -e "\033[38;5;208m     > قہۧنہۧآة آلہۧمہۧطہۧور  :- @Hlusat                     \033[0;00m"
echo -e "\033[38;5;208m     > آلہۧمہۧطہۧور :-         @G0vip                       \033[0;00m"
echo -e "\033[38;5;208m     >  بہۧوتہۧ آلہۧتہۧوآصہۧل :- @F4f4f4bot           \033[0;00m"
echo -e "\033[38;5;208m     > آلآصہۧدآر :- https://github.com/DevSaipa/Oscar   \033[0;00m"
...
EOF
echo -e "                \e[100m                Oscar script           \e[00;37;40m"
echo -e "               \e[01;34m                 By ALI (@G0vip)                \e[00;37;40m"
echo ""
cat << EOF
 $bld$f1 @Hlusat (قناة المطورين)   $f2 @Hlusat (قناة المطورين)    $f3  @Hlusat (قناة المطورين)    $f4 @Hlusat(قناة المطورين)   $f5 @Hlusat (قناة المطورين)    $f6  @Hlusat (قناة المطورين)  $rst
